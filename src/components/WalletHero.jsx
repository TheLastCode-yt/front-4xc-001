...
const WalletHero = () => {
  return (
    <section className="py-10">
      <div className="mx-auto container relative overflow-hidden min-h-[60vh]">
        <div className="max-w-[40%] absolute left-[10%]">
          <h1 className="text-[#2d3436] text-5xl leading-[1.3] font-medium">
        ...
        <div className="flex flex-col gap-y-10 max-w-[40%] absolute bottom-0 left-[10%]">
        ...
        <div className="w-full h-full absolute min-h-[583px] top-0 -z-10">
