  ...
  return (
    <footer className="bg-white">
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-6 max-w-md xl:max-w-4xl text-center leading-relaxed text-black">
          Negocie de forma responsável: O trading de CFDs é uma atividade
          arriscada que pode provocar a perda permanente de capital. Deve
          compreender todos os riscos envolvidos antes de negociar.
        </p>
