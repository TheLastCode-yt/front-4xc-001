...
const ExchangeNumbersSection = () => {
  ...
  return (
    <section className="py-10 bg-[#fbf9f7] relative">
      ...
      <div className="text-[166px] font-bold text-[#f8f4f1] uppercase absolute top-0 left-0 right-0 flex justify-center -z-0 items-center translate-y-1/2">
        {textBackground}
      </div>
            ...
            return (
              <div
                ...
                className={`flex flex-col gap-y-2 items-center py-8
                  ...
                  xl:col-span-3 col-span-12 md:col-span-6
